...
<div class="wrapper">
	...
	<div class="main-panel" id="main-panel">
		...
		<div class="content"> 
			...
			<a style="float:left;" href="newproduct.php">Voeg Product Toe</a>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<td> " . $row["Product_id"]. " </td><td> ". $row["product_name"]. " </td><td> " . $row["prodcuct_prijs"]. " </td><td>  " . $row["formaat"]. "</td><td>  " . $row["dikte"]. " </td><td>  " . $row["vorm"]. " </td><td>  " . $row["kleur"]. " </td><td>  " . $row["thema"]. " </td><td>  " . $row["materiaal"]. " </td><td>  " . $row["stock"]. " </td><td> <img src=\"getproduct.php?Product_id=$row[Product_id]\",, height=\"150\"></img>   </td><td> <a href='productedit.php?id=" . $row["Product_id"]. "'>Pas aan</a> <a href='productdelete.php?id=" . $row["Product_id"]. "'>Verwijder</a></td></tr>";
    }
} else {
    echo "0 results";
}
