...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		...
		echo "<table><tr><td>";
		echo "Voornaam : <input type='text' name='voornaam' value=".$row["voornaam"].">";
		echo "</td><td>";
		echo "Tussenvoegsel : <input type='text' name='tussenvoegsel' value=".$row["tussenvoegsel"].">";
		echo "</td><td>";
		echo "Achternaam : <input type='text' name='achternaam' value=".$row["achternaam"].">";
		echo "</td><td>";
		echo "Geslacht : <input type='text' name='geslacht' value=".$row["geslacht"].">";
		echo "</td><td>";
		echo "Adres : <input type='text' name='adres' value=\"$row[adres]\">";
		echo "</td></tr><tr><td>";
		echo "Huisnummer : <input type='text' name='huisnummer' value=".$row["huisnummer"].">";
		echo "</td><td>";
		echo "Postcode  : <input type='text' name='postcode' value=".$row["postcode"].">";
		echo "</td><td>";
		echo "Geboortedatum : <input type='date' name='geboortedatum' value=".$row["geboortedatum"].">";
		echo "</td><td>";
		echo "Telefoon : <input type='text' name='telefoonnummer' value=".$row["telefoonnummer"].">";
		echo "</td><td>";
