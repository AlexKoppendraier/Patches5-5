	...
	<div class="main-panel" id="main-panel">
		...
		<div class="content"> 
			...
			<tr>
				<?php 
								$id = $_GET["id"];
				$sql = "SELECT op.fk_order_id, op.fk_product_id, op.product_amount, p.*
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<td> <a href='productedit.php?id=" . $row["fk_product_id"]. "'> " . $row["product_name"]. "</a> </td><td> " . $row["product_amount"]. "</td><td>€ " . $row["prodcuct_prijs"]. " </td><td>  " . $row["stock"]. "</td></tr>";
    }
} else {
    echo "0 results";
}
