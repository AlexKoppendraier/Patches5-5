    ...
    switch($_GET["action"]) {
        case "add":
            if(!empty($_POST["quantity"])) {
                ...
                $itemArray = array($productByCode[0]["code"]=>array('name'=>$productByCode[0]["product_name"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["prodcuct_prijs"]));
